...
export default function Hero() {
  return (
    ...
    >
      ...
      <div
        className="absolute top-[60%] right-[10%] w-[400px] h-[400px] bg-[#457b9d] rounded-full blur-[80px] opacity-40 animate-float"
        style={{ animationDelay: "2s" }}
      />
      <div
        className="absolute bottom-[10%] left-[40%] w-[250px] h-[250px] bg-coral rounded-full blur-[80px] opacity-40 animate-float"
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-32 grid md:grid-cols-2 gap-12 items-center">
        ...
        >
          ...
          <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold leading-tight">
            <span className="block text-white/60 text-2xl md:text-3xl font-mono mb-4 font-normal">
              Hi, I&apos;m
            </span>
          ...
          <div className="flex flex-wrap gap-4">
            <a
              href="#projects"
              className="px-8 py-4 bg-accent text-white rounded-full font-semibold hover:shadow-xl hover:shadow-accent/30 transition-all flex items-center gap-2 group"
            >
              View My Work{" "}
              <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
            </a>
            <a
              href="/Anamika_Prajapati.pdf"
              target="_blank"
              rel="noopener noreferrer"
              className="px-8 py-4 glass rounded-full font-semibold hover:border-accent/50 transition-all"
            >
              View CV
            </a>
          </div>
          ...
          <div className="flex gap-6 pt-4">
            ...
            <a
              href="mailto:subiprajapati5@gmail.com"
              className="text-white/40 hover:text-accent transition-colors"
            >
